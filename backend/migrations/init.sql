...
CREATE TABLE IF NOT EXISTS flow_workflow_executions (
    id SERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_flow_workflows_webhook_token ON flow_workflows(webhook_token);
CREATE INDEX IF NOT EXISTS idx_flow_workflows_is_active ON flow_workflows(is_active);
CREATE INDEX IF NOT EXISTS idx_flow_executions_workflow_id ON flow_workflow_executions(workflow_id);
CREATE INDEX IF NOT EXISTS idx_flow_executions_status ON flow_workflow_executions(status);
CREATE INDEX IF NOT EXISTS idx_flow_executions_started_at ON flow_workflow_executions(started_at);
...
CREATE INDEX IF NOT EXISTS idx_sandbox_orders_user_id ON sandbox_orders(user_id);
CREATE INDEX IF NOT EXISTS idx_sandbox_orders_symbol ON sandbox_orders(symbol);
CREATE INDEX IF NOT EXISTS idx_sandbox_orders_exchange ON sandbox_orders(exchange);
CREATE INDEX IF NOT EXISTS idx_sandbox_orders_status ON sandbox_orders(order_status);

CREATE INDEX IF NOT EXISTS idx_sandbox_trades_tradeid ON sandbox_trades(tradeid);
CREATE INDEX IF NOT EXISTS idx_sandbox_trades_orderid ON sandbox_trades(orderid);
CREATE INDEX IF NOT EXISTS idx_sandbox_trades_user_id ON sandbox_trades(user_id);

CREATE INDEX IF NOT EXISTS idx_sandbox_positions_user_id ON sandbox_positions(user_id);
CREATE INDEX IF NOT EXISTS idx_sandbox_holdings_user_id ON sandbox_holdings(user_id);
CREATE INDEX IF NOT EXISTS idx_sandbox_funds_user_id ON sandbox_funds(user_id);
CREATE INDEX IF NOT EXISTS idx_sandbox_config_key ON sandbox_config(config_key);
