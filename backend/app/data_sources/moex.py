...
CalculatedRisk timeframes are mapped to the closest ISS interval.
"""
...
# CalculatedRisk timeframe -> MOEX ISS candle interval (minutes; 24=day, 7=week, 31=month)
...
class MOEXDataSource(BaseDataSource):
    ...
    def __init__(self, board: str = DEFAULT_BOARD):
        ...
        self._session.headers.update({"User-Agent": "CalculatedRisk/MOEX-DataSource"})
