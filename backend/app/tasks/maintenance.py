...
@celery_app.task(name="calculatedrisk.tasks.worker_heartbeat")
...
@celery_app.task(name="calculatedrisk.tasks.cleanup_runtime_metadata")
...
@celery_app.task(
    bind=True,
    name="calculatedrisk.tasks.reflection",
...
@celery_app.task(
    bind=True,
    name="calculatedrisk.tasks.ai_calibration",
    autoretry_for=(Exception,),
    retry_backoff=True,
    retry_jitter=True,
    max_retries=3,
...
@celery_app.task(
    bind=True,
    name="calculatedrisk.tasks.market_catalog_sync",
    autoretry_for=(Exception,),
    retry_backoff=True,
    retry_jitter=True,
    max_retries=3,
