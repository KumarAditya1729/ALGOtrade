    ...
    'brand': {
        ...
        'items': [
            ...
            },
            {
                ...
                'type': 'text',
                'default': '© 2025-2026 CalculatedRisk. All rights reserved.',
        ...
        'items': [
            {
                ...
                'label': 'Support Email',
                'type': 'text',
                'default': 'support@calculatedrisk.com',
            ...
            },
            {
                ...
                'type': 'text',
                'default': 'https://t.me/calculatedrisk',
            ...
            },
            {
                ...
                'type': 'text',
                'default': 'https://github.com/OpenByteInc/CalculatedRisk/issues',
        ...
        'items': [
            {
                ...
                'default': 'tavily',
                'description': 'Primary news/web search provider used by AI analysis. CalculatedRisk falls back to configured providers, then GDELT and DuckDuckGo when available'
            },
            {
    ...
    'security': {
        ...
        'items': [
            ...
            },
            {
                ...
                'type': 'text',
                'required': False,
                'description': 'Comma-separated scheme+host (+ optional port) of additional frontends allowed as OAuth post-login redirect targets, e.g. https://m.calculatedrisk.com,https://app.calculatedrisk.com. FRONTEND_URL is always allowed implicitly.'
            },
            {
...
def get_brand_config():
    ...
    Empty ENV values fall back to the bundled CalculatedRisk defaults so a fresh
            ...
            if requested_admin_email and requested_admin_email != 'admin@example.com':
                ...
                if not admin_username:
                    try:
                        ...
                        admin_username = str(Config.ADMIN_USER or 'calculatedrisk')
                    except Exception:
                        admin_username = 'calculatedrisk'
