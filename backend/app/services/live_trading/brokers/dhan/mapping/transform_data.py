...
from app.services.live_trading.calculatedrisk_compat import get_instrument_type_from_symbol, get_mpp_percentage
...
def transform_data(data, token):
    """
    Transforms the CalculatedRisk API request structure to Dhan v2 API structure.
