...
def process_dhan_csv(path):
    ...
    # Normalize NSE_INDEX symbols: uppercase, remove spaces, only for symbols in CalculatedRisk docs
    ...
    # Revert symbols not in the CalculatedRisk standard set
    ...
    # Normalize BSE_INDEX symbols to CalculatedRisk standard format
    ...
    #
    # So derive it for ALL derivative rows from the CalculatedRisk symbol we just
    ...
    from app.services.live_trading.calculatedrisk_compat import extract_underlying_from_symbol
