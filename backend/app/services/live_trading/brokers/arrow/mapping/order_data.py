from app.services.live_trading.brokers.arrow.mapping.transform_data import reverse_map_product_type
...
# Arrow code -> CalculatedRisk vocabulary (for normalizing broker responses).
...
# Arrow order status -> CalculatedRisk lowercase status (matches the rest of the app).
_STATUS_MAP = {
    "COMPLETE": "complete",
    "OPEN": "open",
    "PENDING": "open",
