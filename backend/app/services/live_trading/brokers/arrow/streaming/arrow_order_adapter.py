...
# Arrow orderStatus values -> CalculatedRisk's lowercase order_status vocabulary.
_STATUS_MAP = {
    "PENDING": "open",
    "OPEN": "open",
    "COMPLETE": "complete",
...
# Arrow "order" (order type) codes -> CalculatedRisk pricetype constants
_PRICETYPE_MAP = {"LMT": "LIMIT", "MKT": "MARKET", "SL": "SL", "SL-M": "SL-M"}

# Arrow product codes -> CalculatedRisk product constants
...
class ArrowOrderUpdateAdapter(BaseOrderUpdateAdapter):
    ...
    def normalize(self, raw_message):
        ...
        # Symbol -> CalculatedRisk format (get_oa_symbol on Arrow's brsymbol, with
