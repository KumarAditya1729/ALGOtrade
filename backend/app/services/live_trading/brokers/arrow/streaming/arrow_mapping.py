...
class ArrowExchangeMapper:
    """CalculatedRisk <-> Arrow exchange codes. Indices collapse to Arrow 'INDEX' on
    ...
    instrument. We retain the CalculatedRisk exchange per token for topic routing."""
...
class ArrowCapabilityRegistry:
    ...
    # CalculatedRisk capability -> Arrow subscription mode.
    ...
    # CalculatedRisk numeric mode (1/2/3) -> Arrow subscription mode.
    MODE_MAP = {
        1: "ltpc",
        2: "quote",
        3: "full",
