...
from app.services.live_trading.brokers.jainamxts.streaming.jainamxts_websocket import JainamXTSWebSocketClient
...
class JainamXTSWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if not auth_data:
            ...
            auth_token = CredentialService.load_by_exchange(user_id, "jainamxts").api_key
            ...
            if not auth_token or not feed_token:
                ...
                raise ValueError(f"No authentication tokens found for user {user_id}", "jainamxts").access_token
