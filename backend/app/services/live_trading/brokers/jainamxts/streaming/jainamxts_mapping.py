...
class JainamXTSExchangeMapper:
    """Maps between CalculatedRisk exchange codes and JainamXTS specific exchange types"""

    # Exchange type mapping for JainamXTS broker
    # Format: {CalculatedRisk_Exchange: JainamXTS_Exchange_Code}
    ...
    # Reverse mapping for converting JainamXTS exchange codes to CalculatedRisk format
    # Format: {JainamXTS_Exchange_Code: CalculatedRisk_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert CalculatedRisk exchange code to JainamXTS specific exchange type
    ...
    @staticmethod
    def get_calculatedrisk_exchange(jainamxts_code):
        """
        Convert JainamXTS exchange code to CalculatedRisk exchange code
