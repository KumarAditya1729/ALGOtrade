...
from app.services.live_trading.brokers.jainamxts.baseurl import INTERACTIVE_URL
from app.services.live_trading.brokers.jainamxts.mapping.transform_data import (
    map_product_type,
...
def get_open_position(tradingsymbol, exchange, producttype, auth):
    ...
    # Map exchange from CalculatedRisk format to XTS format
    exchange_mapping = {
        "NSE": "NSECM",
        "BSE": "BSECM",
        "NFO": "NSEFO",
