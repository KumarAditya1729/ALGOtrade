...
from app.services.live_trading.brokers.aliceblue.mapping.transform_data import reverse_map_product_type
...
def transform_holdings_data(holdings_data):
    ...
    for holdings in holdings_data:
        ...
        try:
            ...
            # Convert broker symbol to CalculatedRisk format, as the orderbook,
            ...
            # symbols ("NIFTYBEES-EQ") where every other view shows CalculatedRisk
            ...
            if oa_symbol:
                ...
                logger.warning(
                    f"No CalculatedRisk symbol for {symbol} on {exchange}; keeping the broker symbol"
                )
