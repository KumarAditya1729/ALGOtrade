...
from app.services.live_trading.brokers.aliceblue.api.rate_limiter import apply_rate_limit
from app.services.live_trading.calculatedrisk_compat import Auth
from app.services.live_trading.calculatedrisk_compat import get_br_symbol, get_brexchange, get_oa_symbol, get_token
...
class BrokerData:
    ...
    def get_websocket(self, force_new=False):
        ...
        # CalculatedRisk is single-user, single-broker per instance.
        ...
        try:
            ...
            # Register this session and evict any other. CalculatedRisk is
    ...
    def _map_exchange(self, exchange: str) -> str:
        """Map CalculatedRisk exchange codes to AliceBlue API exchange codes."""
        exchange_map = {
            "NSE_INDEX": "NSE",
            "BSE_INDEX": "BSE",
            "MCX_INDEX": "MCX",
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        Returns:
            dict: Quote data in CalculatedRisk standard format
        """
    ...
    def get_depth(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            # Return in CalculatedRisk standard format (matching Angel broker)
            return {
                "bids": bids,
                "asks": asks,
