...
#: Broker index code -> CalculatedRisk symbol (docs/prompt/symbol-format.md).
_INDEX_SYMBOL_ALIASES = {
            ...
            # BSE Index Symbols (AliceBlue -> CalculatedRisk)
            "SNSX50": "SENSEX50",
...
def process_aliceblue_indices_csv(path):
    ...
    # Step 1: Apply the explicit broker -> CalculatedRisk renames FIRST.
    #
