...
from app.services.live_trading.brokers.pocketful.api.packet_decoder import (
...
class PocketfulWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if not auth_data:
            ...
            auth_token = CredentialService.load_by_exchange(user_id, "pocketful").api_key
    ...
    def _connect_with_retry(self) -> None:
        ...
        while self.running and self.reconnect_attempts < self.max_reconnect_attempts:
            try:
                ...
                fresh_token = CredentialService.load_by_exchange(self.user_id, "pocketful").api_key
                if fresh_token:
    ...
    def subscribe(
        ...
        """
        # Map CalculatedRisk mode to Pocketful mode
        # CalculatedRisk: 1=LTP, 2=Quote, 3=Depth
