...
def process_pocketful_mcx_csv(path):
    ...
    CalculatedRisk MCX Symbol Format:
    ...
    # Define the function to build CalculatedRisk symbol
    def build_calculatedrisk_symbol(row):
        try:
    ...
    df["symbol"] = df.apply(build_calculatedrisk_symbol, axis=1)
