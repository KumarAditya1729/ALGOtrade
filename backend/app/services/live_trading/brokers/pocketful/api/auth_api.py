...
from app.services.live_trading.calculatedrisk_compat import get_broker_api_key, get_broker_api_secret
...
def authenticate_broker(auth_code=None, state=None):
    ...
    try:
        ...
        redirect_uri = get_broker_env("REDIRECT_URL", "http://127.0.0.1:5000/pocketful/callback")
