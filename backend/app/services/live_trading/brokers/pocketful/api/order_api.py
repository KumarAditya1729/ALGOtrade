...
from app.services.live_trading.brokers.pocketful.mapping.transform_data import (
    map_product_type,
    reverse_map_product_type,
    transform_data,
    transform_modify_order_data,
)
from app.services.live_trading.calculatedrisk_compat import Auth, db_session
from app.services.live_trading.calculatedrisk_compat import get_br_symbol, get_oa_symbol
...
def get_holdings(auth):
    ...
    from app.services.live_trading.brokers.pocketful.mapping.order_data import transform_holdings_data
...
def place_order_api(data, auth_token):
    ...
    # Transform CalculatedRisk order format to Pocketful format
...
def modify_order(data, auth):
    ...
    # Transform CalculatedRisk modify order format to Pocketful format
