...
from app.services.live_trading.brokers.fivepaisaxts.baseurl import INTERACTIVE_URL, MARKET_DATA_URL
...
def load_by_exchange():
    try:
        # Fetch credentials for feed token
        BROKER_API_KEY_MARKET = get_broker_env("BROKER_API_KEY_MARKET")
        BROKER_API_SECRET_MARKET = get_broker_env("BROKER_API_SECRET_MARKET", "fivepaisaxts").access_token
