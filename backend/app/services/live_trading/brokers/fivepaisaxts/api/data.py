...
from app.services.live_trading.brokers.fivepaisaxts.api.auth_api import get_feed_token as refresh_feed_token
from app.services.live_trading.brokers.fivepaisaxts.baseurl import MARKET_DATA_URL
from app.services.live_trading.brokers.fivepaisaxts.database.master_contract_db import SymToken, db_session
from app.services.live_trading.credentials.service import CredentialService
from app.services.live_trading.calculatedrisk_compat import get_br_symbol, get_brexchange, get_oa_symbol
    ...
    def get_market_depth(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            if not feed_token:
                ...
                feed_token, new_user_id, error = CredentialService.load_by_exchange()
                if error:
