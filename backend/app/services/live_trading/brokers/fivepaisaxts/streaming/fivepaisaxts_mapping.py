...
class FivepaisaXTSExchangeMapper:
    """Maps between CalculatedRisk exchange codes and Fivepaisa XTS specific exchange types"""

    # Exchange type mapping for Fivepaisa XTS broker
    # Format: {CalculatedRisk_Exchange: Fivepaisa_Exchange_Code}
    ...
    # Reverse mapping for converting Fivepaisa exchange codes to CalculatedRisk format
    # Format: {Fivepaisa_Exchange_Code: CalculatedRisk_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert CalculatedRisk exchange code to Fivepaisa XTS specific exchange type
    ...
    @staticmethod
    def get_calculatedrisk_exchange(fivepaisaxts_code):
        """
        Convert Fivepaisa XTS exchange code to CalculatedRisk exchange code
