...
from app.services.live_trading.brokers.fivepaisaxts.streaming.fivepaisaxts_websocket import FivepaisaXTSWebSocketClient
...
class FivepaisaXTSWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if not auth_data:
            ...
            auth_token = CredentialService.load_by_exchange(user_id, "fivepaisaxts").api_key
            ...
            if not auth_token or not feed_token:
                ...
                raise ValueError(f"No authentication tokens found for user {user_id}", "fivepaisaxts").access_token
    ...
    def _process_json_data(self, data: dict):
        ...
        try:
            ...
            self.logger.info(f"Environment ZMQ_PORT: {get_broker_env('ZMQ_PORT', 'Not Set')}")
