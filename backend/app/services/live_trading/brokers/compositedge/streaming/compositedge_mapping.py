...
class CompositedgeExchangeMapper:
    """Maps between CalculatedRisk exchange codes and Compositedge XTS specific exchange types"""

    # Exchange type mapping for Compositedge XTS broker
    # Format: {CalculatedRisk_Exchange: Compositedge_Exchange_Code}
    ...
    # Reverse mapping for converting Compositedge exchange codes to CalculatedRisk format
    # Format: {Compositedge_Exchange_Code: CalculatedRisk_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert CalculatedRisk exchange code to Compositedge XTS specific exchange type
    ...
    @staticmethod
    def get_calculatedrisk_exchange(compositedge_code):
        """
        Convert Compositedge XTS exchange code to CalculatedRisk exchange code

        Args:
            compositedge_code (int): Compositedge exchange code

        Returns:
            str: CalculatedRisk exchange code
        """
