...
from app.services.live_trading.brokers.compositedge.baseurl import INTERACTIVE_URL, MARKET_DATA_URL
...
def load_by_exchange():
    try:
        ...
        BROKER_API_SECRET_MARKET = get_broker_env("BROKER_API_SECRET_MARKET", "compositedge").access_token
