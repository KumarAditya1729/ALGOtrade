...
from app.services.live_trading.brokers.wisdom.streaming.wisdom_websocket import WisdomWebSocketClient
...
class WisdomWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if not auth_data:
            ...
            auth_token = CredentialService.load_by_exchange(user_id, "wisdom").api_key
            ...
            if not auth_token or not feed_token:
                ...
                raise ValueError(f"No authentication tokens found for user {user_id}", "wisdom").access_token
