...
class WisdomExchangeMapper:
    """Maps between CalculatedRisk exchange codes and Wisdom XTS specific exchange types"""

    # Exchange type mapping for Wisdom XTS broker
    # Format: {CalculatedRisk_Exchange: Wisdom_Exchange_Code}
    ...
    # Reverse mapping for converting Wisdom exchange codes to CalculatedRisk format
    # Format: {Wisdom_Exchange_Code: CalculatedRisk_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert CalculatedRisk exchange code to Wisdom XTS specific exchange type
    ...
    @staticmethod
    def get_calculatedrisk_exchange(wisdom_code):
        """
        Convert Wisdom XTS exchange code to CalculatedRisk exchange code
