...
from app.services.live_trading.calculatedrisk_compat import get_oa_symbol, get_symbol, get_symbol_info
...
def map_order_data(order_data):
    """
    Normalises a list of Delta Exchange order dicts to the CalculatedRisk internal format.
...
def map_trade_data(trade_data):
    """
    Normalises a list of Delta Exchange fill/trade dicts to the CalculatedRisk internal format.
...
def transform_tradebook_data(tradebook_data):
    """
    Transform Delta Exchange fill/trade data to CalculatedRisk standard format.
...
def map_position_data(position_data):
    """
    Normalises a list of Delta Exchange position dicts to the CalculatedRisk internal format.
