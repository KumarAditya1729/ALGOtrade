...
# Mapping CalculatedRisk margin positions to Delta Exchange margin_required API format
# Delta Exchange endpoint: GET /v2/products/{product_id}/margin_required

from app.services.live_trading.brokers.deltaexchange.mapping.transform_data import _order_size
...
def transform_margin_positions(positions):
    """
    Transform CalculatedRisk margin position list to Delta Exchange format.

    Each CalculatedRisk position is converted to a dict with the fields needed
    ...
    Args:
        positions: List of dicts in CalculatedRisk format
...
def parse_margin_response(response_data):
    ...
    CalculatedRisk margin format (3 fields):
