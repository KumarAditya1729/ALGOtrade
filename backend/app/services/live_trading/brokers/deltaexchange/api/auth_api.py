...
from app.services.live_trading.brokers.deltaexchange.api.baseurl import BASE_URL, get_auth_headers, get_url
...
def authenticate_broker(code):
    ...
    """
    try:
        api_key = get_broker_env("BROKER_API_KEY", "").strip()
        api_secret = get_broker_env("BROKER_API_SECRET", "").strip()
