...
from app.services.live_trading.brokers.deltaexchange.api.baseurl import BASE_URL
...
class BrokerData:
    ...
    # Delta Exchange supported candle resolutions mapped from CalculatedRisk interval codes.
    ...
    def __init__(self, auth_token: str):
        """Initialise with the api_key stored in the CalculatedRisk auth DB."""
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        Field mapping (ticker result → CalculatedRisk):
    ...
    def get_option_chain(
        ...
        Args:
            ...
            exchange:   CalculatedRisk exchange code.  ``"CRYPTO"`` for all Delta
        ...
        """
        from app.services.live_trading.brokers.deltaexchange.database.master_contract_db import SymToken
    ...
    def get_intervals(self) -> list:
        """
        Return the list of supported CalculatedRisk interval codes for Delta Exchange.
        """
    ...
    def _get_br_symbol(self, symbol: str, exchange: str) -> str:
        """
        Resolve CalculatedRisk symbol → Delta Exchange contract symbol (brsymbol).
