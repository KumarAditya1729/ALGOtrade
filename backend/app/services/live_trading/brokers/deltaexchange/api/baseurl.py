...
BASE_URL = get_broker_env("DELTA_BASE_URL", "https://api.india.delta.exchange")
...
def get_auth_headers(
    ...
    """
    key = api_key or get_broker_env("BROKER_API_KEY", "")
    secret = api_secret or get_broker_env("BROKER_API_SECRET", "")
    ...
    return {
        ...
        "timestamp": timestamp,
        "signature": signature,
        "User-Agent": "calculatedrisk-python-client",
