# api/funds.py
# Delta Exchange wallet balance → CalculatedRisk margin format
# Endpoints:
...
from app.services.live_trading.brokers.deltaexchange.api.baseurl import BASE_URL, get_auth_headers
...
def get_margin_data(auth_token):
    """
    Fetch wallet balance from Delta Exchange and return it in CalculatedRisk margin format.
    ...
    Args:
        auth_token (str): api_key stored in CalculatedRisk auth DB after login.

    Returns:
        dict: CalculatedRisk standard margin dict, or DEFAULT_MARGIN_RESPONSE on failure.
    """
    api_key = auth_token
