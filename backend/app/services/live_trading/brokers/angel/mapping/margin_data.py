...
def transform_margin_positions(positions):
    """
    Transform CalculatedRisk margin position format to Angel Broking margin format.
...
def map_product_type(product):
    """
    Maps CalculatedRisk product type to Angel Broking product type.
...
def map_order_type(pricetype):
    """
    Maps CalculatedRisk price type to Angel Broking order type.

    CalculatedRisk: MARKET, LIMIT, SL, SL-M
...
def parse_margin_response(response_data):
    """
    Parse Angel Broking margin calculator response to CalculatedRisk standard format.
