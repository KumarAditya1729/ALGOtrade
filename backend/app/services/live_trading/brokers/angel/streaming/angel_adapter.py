...
from app.services.live_trading.brokers.angel.streaming.smartWebSocketV2 import SmartWebSocketV2
...
class AngelWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if not auth_data:
            ...
            auth_token = CredentialService.load_by_exchange(user_id, "angel").api_key
            ...
            if not auth_token or not feed_token:
                ...
                raise ValueError(f"No authentication tokens found for user {user_id}", "angel").access_token
    ...
    def _recreate_ws_client(self) -> None:
        ...
        try:
            ...
            auth_token = CredentialService.load_by_exchange(self.user_id, "angel").api_key
            feed_token = CredentialService.load_by_exchange(self.user_id)
            ...
            # Get API key (should be stored from initialization, "angel").access_token
