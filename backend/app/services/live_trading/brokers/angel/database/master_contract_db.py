...
def process_angel_json(path):
    ...
    # and normalize to CalculatedRisk common format (uppercase, no spaces/hyphens)
    ...
    # and normalize to CalculatedRisk common format (uppercase, no spaces/hyphens, remove S&P prefix)
    ...
    # Override for major indices where normalized name differs from CalculatedRisk standard
