...
QUOTE_MIN_INTERVAL = float(get_broker_env("ANGEL_QUOTE_MIN_INTERVAL", "0.15"))      # ~6.6 req/s (limit 10)
...
HISTORY_MIN_INTERVAL = float(get_broker_env("ANGEL_HISTORY_MIN_INTERVAL", "0.5"))   # ~2 req/s (limit 3)
