...
def process_upstox_json(path):
    ...
    exchange_map = {
        ...
        "BCD_FO": "BCD",
        "MCX_FO": "MCX",
        # Upstox quote-only world feeds — folded into CalculatedRisk's GLOBAL_INDEX
    ...
    # NSE Index Symbol Mapping (Upstox trading_symbol → CalculatedRisk format)
    ...
    # Mapped to CalculatedRisk standard symbols listed in docs/prompt/symbol-format.md.
