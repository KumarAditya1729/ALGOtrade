...
from app.services.live_trading.brokers.upstox.mapping.transform_data import map_product_type
...
def transform_margin_positions(positions):
    """
    Transform CalculatedRisk margin position format to Upstox margin format.
...
def parse_margin_response(response_data):
    """
    Parse Upstox margin response to CalculatedRisk standard format.
