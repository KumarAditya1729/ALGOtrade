...
class UpstoxExchangeMapper:
    """Maps between CalculatedRisk exchange codes and Upstox specific exchange types"""

    # Exchange type mapping for Upstox broker
    # Format: {CalculatedRisk_Exchange: Upstox_Exchange_Code}
    EXCHANGE_TYPES = {
        # NSE Segments
    ...
    # Reverse mapping for converting Upstox exchange codes to CalculatedRisk format
    # Format: {Upstox_Exchange_Code: CalculatedRisk_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert CalculatedRisk exchange code to Upstox specific exchange type
    ...
    @staticmethod
    def get_calculatedrisk_exchange(upstox_code):
        """
        Convert Upstox exchange code to CalculatedRisk exchange code
