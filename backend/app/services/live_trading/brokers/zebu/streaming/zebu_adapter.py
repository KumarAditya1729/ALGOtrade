"""
Zebu WebSocket Adapter for CalculatedRisk
...
class ZebuWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        self.susertoken = CredentialService.load_by_exchange(user_id, "zebu").api_key
    ...
    def _attempt_reconnection(self) -> None:
        ...
        try:
            ...
            fresh_token = CredentialService.load_by_exchange(self.user_id, "zebu").api_key
            with self.lock:
                if fresh_token:
