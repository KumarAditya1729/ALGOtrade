...
def process_scrip_data(scrip_data, group_info):
        ...
        for item in scrip_data:
            try:
                ...
                if len(parts) >= 3:
                    ...
                    # Map exchange for CalculatedRisk format
            ...
            try:
                ...
                if group_name == "Securities":
                    ...
                    try:
                        ...
                        calculatedrisk_symbol = f"{base_symbol}{expiry_formatted}FUT"
    ...
    # --- NSE Index Symbol Normalization (Tradejini symbol → CalculatedRisk format) ---
    ...
    # --- BSE Index Symbol Normalization (Tradejini symbol → CalculatedRisk format) ---
