...
def transform_data(data, token):
    """
    Transforms CalculatedRisk order format to Tradejini API format.
    """
...
def transform_modify_order_data(data, token):
    """
    Transforms CalculatedRisk modify order format to Tradejini API format.

    Args:
        data (dict): CalculatedRisk modify order data
...
def map_order_type(pricetype):
    """
    Maps CalculatedRisk order types to Tradejini order types.
    """
    order_type_mapping = {
        "MARKET": "market",
        "LIMIT": "limit",
...
def map_product_type(product):
    """
    Maps CalculatedRisk product types to Tradejini product types.
    """
...
def map_validity(validity, exchange=None):
    """
    Maps CalculatedRisk validity types to Tradejini validity types.

    Args:
        validity: CalculatedRisk validity - DAY, IOC, GTC or EOS.
        exchange: CalculatedRisk exchange code. 'eos' (End-of-Session) is accepted for
...
def reverse_map_product_type(product):
    """
    Maps Tradejini product types back to CalculatedRisk product types.
...
def reverse_map_order_type(order_type):
    """
    Maps Tradejini price types back to CalculatedRisk price types.
