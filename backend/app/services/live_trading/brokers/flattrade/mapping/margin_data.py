...
from app.services.live_trading.brokers.flattrade.mapping.transform_data import map_order_type, map_product_type
...
def _apply_mpp(position, auth_token):
    ...
    try:
        ...
        from app.services.live_trading.brokers.flattrade.api.data import BrokerData
