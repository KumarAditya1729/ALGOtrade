"""
Flattrade WebSocket Adapter for CalculatedRisk
...
class FlattradeWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def __init__(self):
        ...
        actual_zmq_port = get_broker_env("ZMQ_PORT", "5555")
        self.logger.info(
    ...
    def initialize(
        ...
        self.accesstoken = CredentialService.load_by_exchange(user_id, "flattrade").api_key
    ...
    def _attempt_reconnection(self) -> None:
        ...
        with self.lock:
            ...
            try:
                ...
                fresh_token = CredentialService.load_by_exchange(self.user_id, "flattrade").api_key
                if fresh_token:
