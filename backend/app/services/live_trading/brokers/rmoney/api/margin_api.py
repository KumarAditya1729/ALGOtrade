...
from app.services.live_trading.brokers.rmoney.mapping.margin_data import parse_margin_response, transform_margin_positions
...
def calculate_margin_api(positions, auth):
    ...
    The CalculatedRisk framework calls this function with a list of positions and
