...
class RMoneyExchangeMapper:
    """Maps between CalculatedRisk exchange codes and RMoney XTS specific exchange types"""

    # Exchange type mapping for RMoney XTS broker
    # Format: {CalculatedRisk_Exchange: RMoney_Exchange_Code}
    ...
    # Reverse mapping for converting RMoney exchange codes to CalculatedRisk format
    # Format: {RMoney_Exchange_Code: CalculatedRisk_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert CalculatedRisk exchange code to RMoney XTS specific exchange type
    ...
    @staticmethod
    def get_calculatedrisk_exchange(rmoney_code):
        """
        Convert RMoney XTS exchange code to CalculatedRisk exchange code
