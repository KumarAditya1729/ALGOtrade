...
from app.services.live_trading.brokers.rmoney.streaming.rmoney_websocket import RMoneyWebSocketClient
...
class RMoneyWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if not auth_data:
            ...
            auth_token = CredentialService.load_by_exchange(user_id, "rmoney").api_key
            ...
            if not auth_token or not feed_token:
                ...
                raise ValueError(f"No authentication tokens found for user {user_id}", "rmoney").access_token
