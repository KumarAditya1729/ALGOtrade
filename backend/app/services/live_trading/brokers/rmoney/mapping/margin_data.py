...
from app.services.live_trading.brokers.rmoney.mapping.transform_data import map_exchange_numeric, map_order_type, map_product_type
...
def transform_margin_positions(positions):
    """
    Transform CalculatedRisk margin position format to RMoney XTS margin API format.
...
def parse_margin_response(response_data):
    """
    Parse RMoney XTS margin calculator response to CalculatedRisk standard format.
    ...
    Returns:
        dict: Parsed margin data in CalculatedRisk format
    """
