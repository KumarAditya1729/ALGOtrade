...
def format_strike(strike_val):
    """Format strike price for CalculatedRisk symbol. Integer if whole number, else decimal."""
    try:
...
def process_iiflcapital_indices_csv(path):
    ...
    # Determine CalculatedRisk exchange from CSV Exchange column
