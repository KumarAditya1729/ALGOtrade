...
from app.services.live_trading.brokers.iiflcapital.mapping.transform_data import map_exchange
...
def transform_margin_positions(positions):
    """
    Transform CalculatedRisk margin positions to IIFL Capital span/exposure format.
...
def parse_margin_response(response_data):
    """
    Parse IIFL Capital span/exposure response to CalculatedRisk standard format.
