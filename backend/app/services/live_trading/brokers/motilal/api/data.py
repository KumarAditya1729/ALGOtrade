...
class BrokerData:
    ...
    def _detect_index_exchange(self, symbol: str) -> str:
        ...
        # Try database lookup
        try:
            from app.services.live_trading.calculatedrisk_compat import db_session
            from app.services.live_trading.calculatedrisk_compat import SymToken
    ...
    def get_websocket(self, force_new=False):
        ...
        client_id = get_broker_env("BROKER_API_KEY", "")
        api_key = get_broker_env("BROKER_API_SECRET", "")
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        Args:
            symbol: Trading symbol (CalculatedRisk format)
        ...
        try:
            ...
            # Map CalculatedRisk exchange to Motilal exchange
            from app.services.live_trading.brokers.motilal.mapping.transform_data import map_exchange
            ...
            # Return quote in CalculatedRisk common format
            return {
    ...
    def get_depth(self, symbol: str, exchange: str) -> dict:
        ...
        This follows the CalculatedRisk standard structure matching Angel and other brokers.
        ...
        Returns:
            dict: Market depth data in CalculatedRisk standard format
        """
        ...
        try:
            ...
            # Create a normalized depth structure in the CalculatedRisk format
            ...
            # Return in Angel's CalculatedRisk standard format (matching lines 524-537 of angel/api/data.py)
            return {
                "bids": formatted_bids,
                "asks": formatted_asks,
                "high": high,
