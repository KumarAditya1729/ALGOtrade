...
#
# Converts raw HDFC Sky account JSON into the documented CalculatedRisk common
...
# HDFC Sky order status -> CalculatedRisk lowercase status.
#
...
def _oa_symbol(brsymbol, exchange):
    """Broker trading symbol -> CalculatedRisk symbol, falling back to the raw value
