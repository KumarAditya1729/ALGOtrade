...
from app.services.live_trading.brokers.hdfcsky.api.data import _series_type
from app.services.live_trading.brokers.hdfcsky.database.master_contract_db import SymToken, db_session
from app.services.live_trading.brokers.hdfcsky.mapping.margin_data import build_margin_leg, parse_margin_response
from app.services.live_trading.brokers.hdfcsky.mapping.transform_data import to_ltp_exchange
...
def calculate_margin_api(positions, auth, api_key=None):
    ...
    Args:
        ...
        api_key: CalculatedRisk API key (unused; present for interface parity)
