...
from app.services.live_trading.brokers.hdfcsky.mapping.order_data import CANCELLABLE_STATUSES
...
def get_order_book(auth):
    ...
    `type=completed`); CalculatedRisk's orderbook is a single list, so both are
...
def get_positions(auth):
    ...
    netwise view, which is what CalculatedRisk's position book represents."""
