"""HDFC Sky WebSocket adapter -> CalculatedRisk unified streaming.
...
from app.services.live_trading.brokers.hdfcsky.mapping.transform_data import ws_scrip_id
from app.services.live_trading.brokers.hdfcsky.streaming.hdfcsky_mapping import HDFCSkyCapabilityRegistry
from app.services.live_trading.brokers.hdfcsky.streaming.hdfcsky_websocket import HDFCSkyWebSocket
...
# CalculatedRisk numeric mode -> topic suffix. The proxy fans a higher mode down to
    ...
    def initialize(self, broker_name, user_id, auth_data=None):
        try:
            ...
            if auth_data and auth_data.get("token"):
                ...
                access_token = CredentialService.load_by_exchange(user_id, "hdfcsky").api_key
