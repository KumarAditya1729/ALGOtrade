...
from app.services.live_trading.brokers.firstock.mapping.transform_data import map_order_type, map_product_type
...
def _build_order(position, auth_token):
    """Build a single Firstock basketMargin leg from an CalculatedRisk position."""
...
def transform_margin_positions(positions, userid, auth_token=None):
    """
    Transform a list of CalculatedRisk positions into a Firstock basketMargin payload.
...
def parse_margin_response(response_data):
    """
    Parse Firstock /V1/basketMargin response into CalculatedRisk's standard shape.
