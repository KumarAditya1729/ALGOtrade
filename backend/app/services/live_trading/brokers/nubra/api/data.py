...
class BrokerData:
    def __init__(self, auth_token):
        ...
        # Map CalculatedRisk timeframe format to Nubra intervals
    ...
    def _get_quotes_via_websocket(self, symbol: str, exchange: str) -> dict:
        ...
        Returns:
            dict: Quote data in CalculatedRisk format, or None if not available
        """
        websocket = None
    ...
    def _get_quotes_via_rest(self, symbol: str, exchange: str) -> dict:
        ...
        Returns:
            dict: Quote data in CalculatedRisk format, or None if failed
        """
        try:
    ...
    def get_history(
        ...
        try:
            ...
            # Reorder columns to match CalculatedRisk REST API format
    ...
    def _get_depth_via_websocket(self, symbol: str, exchange: str) -> dict:
        ...
        Returns:
            dict: Depth data in CalculatedRisk format, or None if not available
        """
        websocket = None
        token_int = None
        subscribed = False
    ...
    def _get_depth_via_rest(self, symbol: str, exchange: str) -> dict:
        ...
        Returns:
            dict: Depth data in CalculatedRisk format, or None if failed
        """
        try:
            if exchange.endswith('_INDEX'):
                return None
    ...
    def get_intervals(self) -> list:
        ...
        CalculatedRisk supported: 1m, 3m, 5m, 15m, 30m, 1h, D
