...
from app.services.live_trading.brokers.nubra.api.baseurl import get_base_url, get_device_id, get_nubra_headers
...
def _get_credentials():
    ...
    """
    phone = get_broker_env("BROKER_API_KEY")  # Mobile number
    mpin = get_broker_env("BROKER_API_SECRET")  # MPIN
...
def request_login_otp():
    ...
    CalculatedRisk uses this rather than the TOTP flow because TOTP has to be
...
def authenticate_broker_totp(totp_code):
    ...
    Not the default login path -- CalculatedRisk logs in with phone-OTP via
...
#
# The four-step flow from the V3 "Nubra Auth Flow" section. This is CalculatedRisk's
