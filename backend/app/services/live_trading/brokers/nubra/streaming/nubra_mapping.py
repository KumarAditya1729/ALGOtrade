...
class NubraExchangeMapper:
    """Maps CalculatedRisk exchange codes to Nubra-specific exchanges."""

    # CalculatedRisk exchange -> Nubra WebSocket exchange.
    ...
    def to_nubra_exchange(exchange: str) -> str:
        """
        Convert CalculatedRisk exchange to Nubra exchange.
