...
def transform_margin_positions(positions):
    """
    Transform CalculatedRisk margin positions into a Nubra V3 funds_required payload.
...

        {
          ...
          "orders": [
            {"refId": 72329, "qty": 1, "side": "BUY", "deliveryType": "IDAY",
             ...
             "stratTags": ["calculatedrisk-margin"]}
          ]
        }
    ...
    for position in positions:
        try:
            ...
            nubra_order = {
                ...
                "isMultiLeg": False,
                "executionMode": "ENTRY",
                "stratTags": [sanitize_strat_tag(position.get("strategy", "calculatedrisk-margin"))],
            }
...
def parse_margin_response(response_data):
    """
    Parse the Nubra V3 funds_required response into the CalculatedRisk standard format.
    ...
    try:
        ...
        # Return standardized format matching the CalculatedRisk API specification.
