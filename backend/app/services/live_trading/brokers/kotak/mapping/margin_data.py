...
from app.services.live_trading.brokers.kotak.mapping.transform_data import (
    map_order_type,
    map_product_type,
...
def transform_margin_position(position):
    """
    Transform a single CalculatedRisk margin position to Kotak margin format.
...
def parse_margin_response(response_data):
    """
    Parse Kotak margin response to CalculatedRisk standard format.
