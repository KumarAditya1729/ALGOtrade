...
from app.services.live_trading.calculatedrisk_compat import get_br_symbol, get_brexchange, get_token
...
class BrokerData:
    ...
    def _get_kotak_exchange(self, exchange):
        """Map CalculatedRisk exchange to Kotak exchange segment"""
        exchange_map = {
            "NSE": "nse_cm",
            "BSE": "bse_cm",
            "NFO": "nse_fo",
    ...
    def _get_index_symbol_candidates(self, symbol):
        """Return candidate Neo API neoSymbol names for an CalculatedRisk index symbol.
