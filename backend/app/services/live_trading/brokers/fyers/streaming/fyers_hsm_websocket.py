...
class FyersHSMWebSocket:
    ...
    def __init__(self, access_token: str, log_path: str = "", user_id: str | None = None):
        ...
        Args:
            ...
            user_id: CalculatedRisk user id, used to re-read a fresh access token from
        ...
        # Source identifier
        self.source = "CalculatedRisk-HSM"
    ...
    def _refresh_access_token(self):
        ...
        if not self.user_id:
            return
        try:
            fresh_token = CredentialService.load_by_exchange(self.user_id, "fyers").api_key
            if not fresh_token:
                self.logger.warning(
