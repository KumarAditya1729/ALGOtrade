...
from app.services.live_trading.brokers.fyers.mapping.margin_data import parse_margin_response, transform_margin_positions
...
def calculate_margin_api(positions, auth):
    ...
    try:
        ...
        # Parse and standardize the response to CalculatedRisk format
