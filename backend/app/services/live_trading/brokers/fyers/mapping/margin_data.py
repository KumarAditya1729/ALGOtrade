...
from app.services.live_trading.brokers.fyers.mapping.transform_data import map_action, map_order_type, map_product_type
...
def transform_margin_positions(positions):
    """
    Transform CalculatedRisk margin position format to Fyers margin format.

    CalculatedRisk Format:
    {
        "symbol": "NIFTY",
        "exchange": "NSE",
        "action": "BUY",
...
def parse_margin_response(response_data):
    """
    Parse Fyers margin response to CalculatedRisk standard format.
    ...
    try:
        ...
        # Return standardized format matching CalculatedRisk specification
