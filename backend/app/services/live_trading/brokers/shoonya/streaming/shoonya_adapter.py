"""
Shoonya WebSocket Adapter for CalculatedRisk
...
class ShoonyaWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        self.susertoken = CredentialService.load_by_exchange(user_id, "shoonya").api_key
    ...
    def _attempt_reconnection(self) -> None:
        ...
        try:
            ...
            fresh_token = CredentialService.load_by_exchange(self.user_id, "shoonya").api_key
