...
class ShoonyaExchangeMapper:
    """Maps between CalculatedRisk exchange names and Shoonya exchange codes"""

    # CalculatedRisk to Shoonya exchange mapping
    EXCHANGE_MAP = {
        "NSE": "NSE",
        "BSE": "BSE",
        "NFO": "NFO",
    ...
    def to_shoonya_exchange(cls, oa_exchange: str) -> str | None:
        """Convert CalculatedRisk exchange to Shoonya exchange format"""
        return cls.EXCHANGE_MAP.get(oa_exchange.upper())

    @classmethod
    def to_oa_exchange(cls, shoonya_exchange: str) -> str | None:
        """Convert Shoonya exchange to CalculatedRisk exchange format"""
