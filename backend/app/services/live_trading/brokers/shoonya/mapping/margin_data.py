...
from app.services.live_trading.brokers.shoonya.mapping.transform_data import map_order_type, map_product_type
...
def _apply_mpp(position, auth_token):
    ...
    try:
        ...
        from app.services.live_trading.brokers.shoonya.api.data import BrokerData
