...
class DefinedgeExchangeMapper:
    """Maps CalculatedRisk exchange codes to DefinEdge-specific exchange types"""
    ...
    def get_exchange_code(exchange):
        """
        Convert CalculatedRisk exchange code to DefinEdge exchange code

        Args:
            exchange (str): CalculatedRisk exchange code
