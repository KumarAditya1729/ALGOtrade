...
from app.services.live_trading.brokers.definedge.streaming.definedge_websocket import DefinedGeWebSocket
...
class DefinedgeWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if not auth_data:
            ...
            auth_token = CredentialService.load_by_exchange(user_id, "definedge").api_key
            feed_token = CredentialService.load_by_exchange(user_id)  # This contains susertoken for DefinEdge
            ...
            from app.services.live_trading.calculatedrisk_compat import get_user_id

            definedge_uid = get_user_id(user_id, "definedge").access_token  # This should return "1272808"
    ...
    def _fetch_fresh_auth_data(self) -> dict[str, Any] | None:
        ...
        if not self.user_id:
            return None
        try:
            auth_token = CredentialService.load_by_exchange(self.user_id, "definedge").api_key
