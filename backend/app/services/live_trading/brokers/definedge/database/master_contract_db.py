...
from app.services.live_trading.calculatedrisk_compat import find_user_by_username
...
def process_definedge_nse_csv(path):
    ...
    try:
        ...
        # Map DefinedGe NSE columns to CalculatedRisk schema
        # Assuming DefinedGe uses standard format: Symbol, Token, Name, etc.
        processed_df = pd.DataFrame()

        if "Symbol" in df.columns:
            processed_df["symbol"] = df["Symbol"] + "-EQ"  # CalculatedRisk format
...
def process_definedge_allmaster_csv(path):
    ...
    try:
        ...
        # Format symbols according to CalculatedRisk standard
        ...
        # Step 3: Explicit rename map for symbols whose cleaned form differs from CalculatedRisk standard
...
def master_contract_download():
    ...
    try:
        ...
        from app.services.live_trading.calculatedrisk_compat import update_status
        from app.services.live_trading.calculatedrisk_compat import get_symbol_count
