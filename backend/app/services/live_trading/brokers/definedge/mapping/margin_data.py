...
from app.services.live_trading.brokers.definedge.mapping.transform_data import map_exchange, map_product_type
...
def transform_margin_positions(positions):
    """
    Transform CalculatedRisk margin positions to Definedge Span Calculator format.
...
def parse_margin_response(response_data):
    """
    Parse Definedge margin response to CalculatedRisk standard format.
    ...
    try:
        ...
        # Return standardized CalculatedRisk format
        return {
            "status": "success",
            "data": {
