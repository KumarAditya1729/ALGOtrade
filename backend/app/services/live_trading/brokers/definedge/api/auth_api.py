...
from app.services.live_trading.brokers.definedge.api.baseurl import SESSION_URL
...
def authenticate_broker(otp_token, otp, api_secret=None):
    ...
    try:
        ...
        api_token = get_broker_env("BROKER_API_KEY")
        ...
        # Return auth string in format expected by CalculatedRisk
