...
from app.services.live_trading.brokers.definedge.api.baseurl import DATA_URL, get_url
from app.services.live_trading.brokers.definedge.api.rate_limiter import MIN_INTERVAL, rate_limited_request
...
def authenticate_broker(api_token, api_secret, otp):
    ...
    """
    try:
        from app.services.live_trading.brokers.definedge.api.auth_api import authenticate_broker as auth_broker
...
class BrokerData:
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            # Map Definedge response fields to CalculatedRisk format
    ...
    def get_history(
        ...
        try:
            ...
            if interval == "D":
                ...
                # This ensures the CalculatedRisk client interprets them correctly
            ...
            # Reorder columns to match CalculatedRisk format (timestamp should be 5th column)
