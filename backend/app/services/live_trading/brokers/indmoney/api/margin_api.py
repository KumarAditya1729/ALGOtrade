...
from app.services.live_trading.brokers.indmoney.mapping.margin_data import parse_margin_response, transform_margin_positions
...
def calculate_margin_api(positions, auth):
    ...
    # Create success response matching CalculatedRisk standard format
