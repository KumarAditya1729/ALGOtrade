...
# Default response format for margin data (CalculatedRisk standard format)
...
def get_margin_data(auth_token):
    ...
    try:
        ...
        try:
            ...
            # CalculatedRisk standard required keys (matching Angel broker format)
            required_keys = [
                "availablecash",
                "collateral",
                "m2mrealized",
            ...
            # Prepare the response in CalculatedRisk standard format
            processed_data = {}

            # Map INDmoney fields to CalculatedRisk standard fields
            field_mapping = {
            ...
            # Day charges are newly documented but have no slot in CalculatedRisk's
