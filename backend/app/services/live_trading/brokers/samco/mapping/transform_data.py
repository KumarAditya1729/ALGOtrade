...
from app.services.live_trading.calculatedrisk_compat import (
...
def resolve_order_type(data, auth_token=None):
    """
    Resolve an CalculatedRisk pricetype to the order type Samco accepts, applying
    ...
    if pricetype == "MARKET":
        ...
        try:
            ...
            from app.services.live_trading.brokers.samco.api.data import BrokerData
...
def transform_data(data, token, auth_token=None):
    """
    Transforms the CalculatedRisk API request structure to Samco expected structure.
...
def transform_modify_order_data(data, auth_token=None):
    """
    Transforms the CalculatedRisk modify order request to Samco expected structure.
...
def map_order_type(pricetype):
    """
    Maps CalculatedRisk pricetype to Samco order type.
...
def map_product_type(product):
    """
    Maps CalculatedRisk product type to Samco product type.
    """
...
def reverse_map_product_type(product):
    """
    Maps Samco product type back to CalculatedRisk product type.
    """
