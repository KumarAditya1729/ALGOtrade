...
from app.services.live_trading.brokers.samco.mapping.margin_data import parse_margin_response, transform_margin_position
...
def calculate_margin_api(positions, auth, api_key=None):
    ...
    Args:
        ...
        api_key: CalculatedRisk API key (optional, not used for Samco)
