...
class BrokerData:
    ...
    def _api_exchange(self, symbol: str, exchange: str) -> str:
        ...
        distinct value. The master contract folds MFO into MCX for the CalculatedRisk
    ...
    def _get_index_name(self, symbol: str, exchange: str = "NSE_INDEX") -> str:
        """
        Resolve an CalculatedRisk index symbol to the exact indexName Samco expects.
