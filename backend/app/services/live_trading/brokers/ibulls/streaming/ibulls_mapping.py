...
class IbullsExchangeMapper:
    """Maps between CalculatedRisk exchange codes and Ibulls XTS specific exchange types"""

    # Exchange type mapping for Ibulls XTS broker
    # Format: {CalculatedRisk_Exchange: iBulls_Exchange_Code}
    ...
    # Reverse mapping for converting iBulls exchange codes to CalculatedRisk format
    # Format: {iBulls_Exchange_Code: CalculatedRisk_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert CalculatedRisk exchange code to Ibulls XTS specific exchange type
    ...
    @staticmethod
    def get_calculatedrisk_exchange(ibulls_code):
        """
        Convert Ibulls XTS exchange code to CalculatedRisk exchange code
