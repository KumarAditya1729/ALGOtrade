...
from app.services.live_trading.brokers.ibulls.streaming.ibulls_websocket import IbullsWebSocketClient
...
class IbullsWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if not auth_data:
            ...
            auth_token = CredentialService.load_by_exchange(user_id, "ibulls").api_key
            ...
            if not auth_token or not feed_token:
                ...
                raise ValueError(f"No authentication tokens found for user {user_id}", "ibulls").access_token
