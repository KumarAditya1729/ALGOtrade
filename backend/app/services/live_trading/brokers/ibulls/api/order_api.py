...
from app.services.live_trading.brokers.ibulls.baseurl import INTERACTIVE_URL
from app.services.live_trading.brokers.ibulls.mapping.transform_data import (
    map_product_type,
...
def place_smartorder_api(data: dict, auth: str) -> tuple:
    """
    Place a smart order to achieve target position size based on the CalculatedRisk specification.
...
def close_all_positions(current_api_key, auth):
    ...
    for position in positions_list:
        ...
        place_order_payload = {
            ...
            "limitPrice": "0",
            "stopPrice": "0",
            "orderUniqueIdentifier": "calculatedrisk",
        }
...
def cancel_order(orderid, auth):
    ...
    # Prepare the payload
    payload = json.dumps({"appOrderID": orderid, "orderUniqueIdentifier": "calculatedrisk"})
