...
from app.services.live_trading.brokers.ibulls.baseurl import INTERACTIVE_URL, MARKET_DATA_URL
...
def get_feed_token():
    try:
        ...
        BROKER_API_SECRET_MARKET = get_broker_env("BROKER_API_SECRET_MARKET", "ibulls")
