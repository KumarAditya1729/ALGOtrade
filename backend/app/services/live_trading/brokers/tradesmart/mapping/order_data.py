...
def normalize_order_status(raw_status):
    """Map a TradeSmart status to an CalculatedRisk status (open/complete/cancelled/rejected)."""
...
def map_order_data(order_data):
    """Normalize raw OrderBook rows: resolve CalculatedRisk symbol + product/pricetype."""
...
def transform_order_data(orders):
    """Convert normalized OrderBook rows into the CalculatedRisk common orderbook shape."""
    if orders is None:
...
def transform_tradebook_data(tradebook_data):
    """Convert normalized TradeBook rows into the CalculatedRisk common tradebook shape."""
    transformed_data = []
...
def transform_positions_data(positions_data):
    """Convert normalized PositionBook rows into the CalculatedRisk common positions shape."""
    transformed_data = []
...
def transform_holdings_data(holdings_data):
    """Convert normalized Holdings into the CalculatedRisk common holdings shape (NSE leg)."""
    transformed_data = []
