...
from app.services.live_trading.brokers.tradesmart.mapping.transform_data import map_order_type, map_product_type
...
def build_order_margin_payload(position, uid=""):
    """Build a /GetOrderMargin payload for a single CalculatedRisk position."""
