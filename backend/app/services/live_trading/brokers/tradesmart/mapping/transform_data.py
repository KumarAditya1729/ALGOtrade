...
def transform_data(data, token=None, uid="", auth_token=None):
    """Transform an CalculatedRisk order request into a TradeSmart PlaceOrder payload.
...
def _apply_mpp(data, action, pricetype, supplied_price, auth_token):
    ...
    try:
        from app.services.live_trading.brokers.tradesmart.api.data import BrokerData
