"""
TradeSmart (Noren v2) WebSocket Adapter for CalculatedRisk

Bridges TradeSmart's JSON market-data feed to CalculatedRisk's unified WebSocket proxy
...
if not get_broker_env("ZMQ_PORT"):
    ...
    def _attempt_reconnection(self) -> None:
        with self.lock:
            ...
            try:
                ...
                fresh_token = CredentialService.load_by_exchange(self.user_id, "tradesmart").api_key
                if fresh_token:
