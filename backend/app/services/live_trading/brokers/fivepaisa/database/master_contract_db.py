...
def process_5paisa_csv(path):
    ...
    # Create a new DataFrame in CalculatedRisk format
    new_df = pd.DataFrame()
    ...
    # contract), but every expiry/F&O lookup in CalculatedRisk matches on the
    ...
    # CalculatedRisk index names NIFTY / BANKNIFTY / FINNIFTY / MIDCPNIFTY /
