...
class FivePaisaExchangeMapper:
    """Maps CalculatedRisk exchange codes to 5Paisa-specific exchange codes"""
    ...
    def get_exchange_code(exchange: str) -> str:
        """
        Convert CalculatedRisk exchange code to 5Paisa exchange code

        Args:
            exchange (str): CalculatedRisk exchange code (e.g., 'NSE', 'BSE', 'NFO')
    ...
    def get_exchange_type(exchange: str) -> str:
        """
        Convert CalculatedRisk exchange to 5Paisa exchange type
