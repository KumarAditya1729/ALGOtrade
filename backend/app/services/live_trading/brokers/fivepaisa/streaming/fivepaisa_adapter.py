...
from app.services.live_trading.brokers.fivepaisa.streaming.fivepaisa_websocket import FivePaisaWebSocket
...
class FivepaisaWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def _rebuild_client_with_fresh_token(self) -> None:
        ...
        fresh_token = CredentialService.load_by_exchange(self.user_id, "fivepaisa").api_key
        if not fresh_token:
            self.logger.warning(
