...
from app.services.live_trading.brokers.fivepaisa.mapping.transform_data import map_exchange, map_exchange_type
...
class BrokerData:
    ...
    def map_interval(self, interval: str) -> str | None:
        """Map an CalculatedRisk interval to the 5Paisa Historical Candles path segment.

        Keys are CalculatedRisk's public interval aliases; values are the Interval
        ...
        clients guessing. "1h" is CalculatedRisk's public name for hourly across the
