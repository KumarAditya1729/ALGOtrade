...
from app.services.live_trading.brokers.fivepaisa.mapping.transform_data import reverse_map_exchange
...
# 5Paisa order statuses -> CalculatedRisk's lowercase orderbook vocabulary.
...
def normalize_order_status(status):
    """Map a 5Paisa OrderStatus to CalculatedRisk's lowercase vocabulary.
...
def transform_order_data(orders):
    ...
    for order in orders:
        ...
        # "quantity" is the ORDER quantity everywhere else in CalculatedRisk, and
