...
from app.services.live_trading.brokers.hdfcsecurities.api.baseurl import (
    base_params,
...
from app.services.live_trading.brokers.hdfcsecurities.mapping.transform_data import to_ltp_exchange, ws_scrip_id
...
class BrokerData:
    ...
    # CalculatedRisk exchanges whose instruments carry open interest.
    ...
    def _collect_feed_snapshot(self, instruments, is_complete):
        ...
        from app.services.live_trading.brokers.hdfcsecurities.streaming.hdfcsecurities_websocket import (
    ...
    _NO_HISTORY_MESSAGE = (
        ...
        "feed. Use CalculatedRisk's Historify store or another data provider for "
