...
#                              "pledge_limit": ...}}}}
#
# Mapping to the CalculatedRisk common format:
...
def _mtm_from_positions(auth_token):
    ...
    """
    try:
        from app.services.live_trading.brokers.hdfcsecurities.api.order_api import _position_rows, get_positions
...
def get_margin_data(auth_token):
    """Fetch and normalize InvestRight funds into the CalculatedRisk common format."""
    try:
