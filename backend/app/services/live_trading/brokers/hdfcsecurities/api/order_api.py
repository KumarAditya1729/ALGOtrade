...
from app.services.live_trading.brokers.hdfcsecurities.mapping.order_data import is_cancellable
...
def _enrich_with_ltp(auth, rows):
    ...
    """
    from app.services.live_trading.brokers.hdfcsecurities.api.data import BrokerData
...
def _position_symbol(position):
    """(CalculatedRisk exchange, CalculatedRisk symbol) for a raw position row."""
    from app.services.live_trading.brokers.hdfcsecurities.mapping.order_data import _oa_symbol
...
def place_smartorder_api(data, auth):
    ...
    from app.services.live_trading.brokers.hdfcsecurities.mapping.transform_data import map_product_type
