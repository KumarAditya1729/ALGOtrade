...
from app.services.live_trading.brokers.zerodha.mapping.gtt_data import (
    map_gtt_book,
...
def _fetch_last_price(symbol, exchange, auth):
    ...
    """
    from app.services.live_trading.brokers.zerodha.api.data import BrokerData
...
def get_gtt_book(auth):
    ...
    CalculatedRisk-normalised GTT objects (see ``map_gtt_book``).
    """
    client = get_httpx_client()
