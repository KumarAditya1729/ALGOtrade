...
from app.services.live_trading.brokers.zerodha.database.master_contract_db import SymToken, db_session
...
# CalculatedRisk→Kite exchange-prefix translation for /quote, /quote/ltp, /quote/ohlc.
...
def _kite_quote_exchange(oa_exchange: str, brexchange: str | None) -> str:
    """Resolve the CalculatedRisk exchange + per-row brexchange to the Kite-side
