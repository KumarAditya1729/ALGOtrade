...
def transform_margin_positions(positions):
    """
    Transform CalculatedRisk margin position format to Zerodha margin format.
...
def map_product_type(product):
    """
    Maps CalculatedRisk product type to Zerodha product type.
...
def map_order_type(pricetype):
    """
    Maps CalculatedRisk price type to Zerodha order type.
...
def parse_margin_response(response_data):
    """
    Parse Zerodha margin response to CalculatedRisk standard format.
