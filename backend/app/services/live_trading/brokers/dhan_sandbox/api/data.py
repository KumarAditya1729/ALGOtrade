...
from app.services.live_trading.brokers.dhan_sandbox.api.baseurl import get_url
from app.services.live_trading.brokers.dhan_sandbox.mapping.transform_data import map_exchange_type
...
class BrokerData:
    ...
    def _parse_option_contract(self, symbol: str):
        """
        Parse option symbol in CalculatedRisk format.
    ...
    def _estimate_spot_from_contracts(self, underlying: str) -> float | None:
        ...
        try:
            from app.services.live_trading.calculatedrisk_compat import fno_search_symbols
        except Exception as e:
    ...
    def get_depth(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            # Return depth data in common format matching CalculatedRisk REST API response
            return {
                "bids": bids,
                "asks": asks,
