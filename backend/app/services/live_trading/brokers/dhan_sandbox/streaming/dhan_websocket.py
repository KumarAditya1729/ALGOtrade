"""
Complete Dhan WebSocket client wrapper for CalculatedRisk.
...
class DhanWebSocket:
    ...
    Bridges the async implementation with CalculatedRisk's threading model.
    """
    ...
    MARKET_FEED_WSS = get_broker_env("DHAN_MARKET_FEED_WSS", "wss://api-feed.dhan.co")
    DEPTH_20_FEED_WSS = get_broker_env(
    ...
    def _parse_ticker_data(self, packet_data):
        ...
        try:
            ...
            # Create tick dictionary in CalculatedRisk format
            tick = {
                "token": token,
    ...
    def _parse_market_update(self, packet_data):
        ...
        try:
            ...
            tick = {
                ...
                "close": close_price,
                "mode": "QUOTE",
                # Additional fields for CalculatedRisk compatibility
    ...
    def _should_use_20_level_depth(
        ...
        if get_broker_env("DHAN_DISABLE_20_LEVEL_DEPTH", "").lower() == "true":
    ...
    def _check_and_send_depth_20(self, token):
        ...
        try:
            ...
            # Format depth data to match the CalculatedRisk standard
            formatted_bids = []
            if data.get("bids"):
            ...
            # Create tick data in CalculatedRisk format with enhanced depth information
            tick = {
                "token": token,
                "instrument_token": token,
                "exchange": exchange,
