...
from app.services.live_trading.brokers.iifl.streaming.iifl_websocket import IiflWebSocketClient
...
class IiflWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if not auth_data:
            ...
            auth_token = CredentialService.load_by_exchange(user_id, "iifl").api_key
            ...
            if not auth_token or not feed_token:
                ...
                raise ValueError(f"No authentication tokens found for user {user_id}", "iifl").access_token
