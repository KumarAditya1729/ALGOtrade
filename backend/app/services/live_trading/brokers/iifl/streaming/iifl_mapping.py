...
class IiflExchangeMapper:
    """Maps between CalculatedRisk exchange codes and Iifl XTS specific exchange types"""

    # Exchange type mapping for Iifl XTS broker
    # Format: {CalculatedRisk_Exchange: Iifl_Exchange_Code}
    ...
    # Reverse mapping for converting Iifl exchange codes to CalculatedRisk format
    # Format: {Iifl_Exchange_Code: CalculatedRisk_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert CalculatedRisk exchange code to Iifl XTS specific exchange type
    ...
    @staticmethod
    def get_calculatedrisk_exchange(iifl_code):
        """
        Convert Iifl XTS exchange code to CalculatedRisk exchange code
