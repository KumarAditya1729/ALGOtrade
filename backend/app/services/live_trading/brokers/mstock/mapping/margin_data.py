...
def transform_margin_positions(positions):
    """
    Transform CalculatedRisk margin position format to mStock Type B margin format.
...
def parse_margin_response(response_data):
    """
    Parse mStock Type B margin calculator response to CalculatedRisk standard format.
