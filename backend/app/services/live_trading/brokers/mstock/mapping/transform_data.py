...
def get_mstock_symbol(symbol: str, exchange: str) -> str:
    ...
    Args:
        symbol: CalculatedRisk format symbol (e.g., "NHPC")
...
def transform_data(data, token):
    """
    Transforms the CalculatedRisk API request structure to mStock Type B format.

    Args:
        data: CalculatedRisk order data
...
def transform_modify_order_data(data, token):
    """
    Transforms the CalculatedRisk modify order request to mStock Type B format.

    Args:
        data: CalculatedRisk modify order data
        token: Symbol token from database
...
def map_order_type(pricetype):
    """
    Maps CalculatedRisk pricetype to mStock Type B order type.
...
def map_product_type(product):
    """
    Maps CalculatedRisk product type to mStock Type B product type.
...
def map_variety(pricetype):
    """
    Maps CalculatedRisk pricetype to mStock Type B variety.
...
def reverse_map_product_type(product):
    """
    Reverse maps mStock Type B product type to CalculatedRisk product type.
    """
