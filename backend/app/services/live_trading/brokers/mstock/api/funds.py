...
from app.services.live_trading.brokers.mstock.database import master_contract_db
...
def get_margin_data(auth_token):
    ...
    try:
        ...
        if margin_data.get("status") == True and margin_data.get("data"):
            ...
            filtered_data = {}
            for mstock_key, calculatedrisk_key in key_mapping.items():
                ...
                filtered_data[calculatedrisk_key] = formatted_value
