...
from app.services.live_trading.brokers.mstock.mapping.transform_data import (
    get_mstock_symbol,
    map_product_type,
...
from app.services.live_trading.calculatedrisk_compat import get_symbol, get_token
...
def get_open_position(tradingsymbol, exchange, producttype, auth):
    ...
    Args:
        tradingsymbol: CalculatedRisk format symbol
...
def place_smartorder_api(data, auth):
    ...
    Args:
        data: CalculatedRisk order data with position_size
        auth: Authentication token
...
def modify_order(data, auth):
    ...
    Args:
        data: CalculatedRisk modify order data with fields:
            - orderid: Order ID to modify
            - symbol: CalculatedRisk symbol
