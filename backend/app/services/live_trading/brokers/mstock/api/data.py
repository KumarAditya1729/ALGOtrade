...
from app.services.live_trading.brokers.mstock.api.mstockwebsocket import MstockWebSocket
from app.services.live_trading.brokers.mstock.mapping.order_data import transform_holdings_data, transform_positions_data
...
class BrokerData:
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            # Return in CalculatedRisk standard format
            return {
    ...
    def _get_historical_data(
        ...
        try:
            ...
            # Reorder columns to match CalculatedRisk format
    ...
    def get_depth(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            # Return depth data in CalculatedRisk standard format
            return {
                "bids": bids,
                "asks": asks,
