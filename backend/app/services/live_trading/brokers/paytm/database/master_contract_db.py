...
def reformat_symbol(row):
    ...
    # as both symbol and brsymbol. Index normalization to CalculatedRisk's standard
...
def _paytm_option_ce_pe(row):
    """
    Derive the CalculatedRisk option instrumenttype ("CE" or "PE") from the
...
def process_paytm_csv(path):
    ...
    # Normalize index symbols to CalculatedRisk's standard naming (see symbol_Openalgo.md).
    ...
    # Only Paytm names listed in CalculatedRisk's standard index list are rewritten;
