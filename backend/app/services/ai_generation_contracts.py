"""Central AI generation contracts for CalculatedRisk code assets."""

SCRIPT_STRATEGY_SYSTEM_PROMPT = """You generate executable CalculatedRisk Strategy API V2 Python.
...
INDICATOR_SYSTEM_CONTRACT = """# CalculatedRisk chart indicator contract
