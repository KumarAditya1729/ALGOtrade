"""Metadata registry for CalculatedRisk agent tools.
...
TOOLS: tuple[ToolDefinition, ...] = (
    ...
    ToolDefinition(
        ...
        description_zh="根据用户确认的需求生成只用于图表展示的 CalculatedRisk 指标草稿。",
        description_en="Generate a chart-only CalculatedRisk indicator draft after requirements are confirmed.",
        route="/indicator-ide",
