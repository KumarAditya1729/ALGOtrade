...
def _hash_secret(value: str) -> str:
    salt = (Config.SECRET_KEY or os.getenv("SECRET_KEY") or "calculatedrisk").encode("utf-8")
...
class MfaService:
    ...
    def start_setup(self, user_id: int, label: str) -> Dict[str, Any]:
        ...
        issuer = (os.getenv("BRAND_APP_NAME") or "CalculatedRisk").strip() or "CalculatedRisk"
