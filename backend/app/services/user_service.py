...
class UserService:
    ...
    BOOTSTRAP_DEFAULT_USERNAME = 'calculatedrisk'
    ...
    def _configured_admin_username(cls) -> str:
        ...
        try:
            from app.config.settings import Config
            return str(Config.ADMIN_USER or os.getenv('ADMIN_USER', 'calculatedrisk') or 'calculatedrisk').strip()
        except Exception:
            return str(os.getenv('ADMIN_USER', 'calculatedrisk') or 'calculatedrisk').strip()
