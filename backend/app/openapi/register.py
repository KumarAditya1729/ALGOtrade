...
def register_human_blueprints(api: Api) -> None:
    ...
    from app.routes.openalgo_compat import openalgo_blp

    registrations: list[tuple] = [
        (health_blp, ""),
        (policy_blp, "/api/v1/policy"),
        (auth_blp, "/api/v1/auth"),
        (user_blp, "/api/v1/users"),
        (kline_blp, "/api/v1/indicator"),
        (backtest_center_blp, "/api/v1/backtest"),
        (market_blp, "/api/v1/market"),
        (universe_blp, "/api/v1/universes"),
        (factors_blp, "/api/v1/factors"),
        (market_modules_blp, "/api/v1/market-modules"),
        (ai_chat_blp, "/api/v1/ai"),
        (indicator_blp, "/api/v1/indicator"),
        (indicator_signal_alerts_blp, "/api/v1/indicator"),
        (strategy_blp, "/api/v1"),
        (credentials_blp, "/api/v1/credentials"),
        (dashboard_blp, "/api/v1/dashboard"),
        (settings_blp, "/api/v1/settings"),
        (portfolio_blp, "/api/v1/portfolio"),
        (ibkr_blp, "/api/v1/ibkr"),
        (alpaca_blp, "/api/v1/alpaca"),
        (global_market_blp, "/api/v1/global-market"),
        (community_blp, "/api/v1/community"),
        (fast_analysis_blp, "/api/v1/fast-analysis"),
        (billing_blp, "/api/v1/billing"),
        (quick_trade_blp, "/api/v1/quick-trade"),
        (openalgo_blp, "/api/v1/openalgo"),
    ]
