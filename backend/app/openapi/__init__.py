"""
OpenAPI / flask-smorest integration for the CalculatedRisk human web API.
...
def init_openapi(app: Flask) -> Api:
    ...
    app.config.setdefault("API_TITLE", "CalculatedRisk Web API")
    app.config.setdefault("API_VERSION", "1.0.0")
    app.config.setdefault("OPENAPI_VERSION", "3.0.3")
    app.config.setdefault(
        "OPENAPI_DESCRIPTION",
        (
            "Human-facing REST API for CalculatedRisk. "
    ...
    app.config.setdefault(
        "API_SPEC_OPTIONS",
        {
            "info": {
                ...
                "contact": {
                    "name": "CalculatedRisk",
                    "url": "https://github.com/OpenByteInc/calculatedrisk",
                },
                "license": {
    ...
    app.extensions["calculatedrisk_openapi_api"] = api
    return api


def get_openapi_api(app: Flask) -> Api | None:
    return app.extensions.get("calculatedrisk_openapi_api")
