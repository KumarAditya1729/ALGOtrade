...
_INSECURE_SECRET_KEYS = {
    "calculatedrisk-secret-key-change-me",
}
...
class MetaConfig(type):
    ...
    @property
    def APP_NAME(cls):
        return 'CalculatedRisk Python API'
    ...
    @property
    def ADMIN_USER(cls):
        return os.getenv('ADMIN_USER', 'calculatedrisk')
    ...
    @property
    def PAPER_TRADING_DEFAULT(cls):
        return os.getenv('PAPER_TRADING_DEFAULT', 'True').lower() == 'true'

    @property
    def LIVE_TRADING_ENABLED(cls):
